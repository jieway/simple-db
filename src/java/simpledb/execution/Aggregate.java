...
public class Aggregate extends Operator {
    ...
    private OpIterator[] child = new OpIterator[1];
    ...
    public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        if (gfield != Aggregator.NO_GROUPING) {
            ...
            this.td = new TupleDesc(new Type[]{gType, Type.INT_TYPE});
        }else {
    ...
    public String groupFieldName() {
        return this.child[0].getTupleDesc().getFieldName(gfield);
    }
    ...
    public String aggregateFieldName() {
        return this.child[0].getTupleDesc().getFieldName(afield);
    }
    ...
    public void open() throws NoSuchElementException, DbException,
        ...
        while (child[0].hasNext()) {
            aggregator.mergeTupleIntoGroup(child[0].next());
        }
